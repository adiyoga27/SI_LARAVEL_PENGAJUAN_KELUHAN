                        ...
                        <div class="card-body">
                            <form action="{{ url('tasks/finish/' . $task->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row align-items-center mb-0">
                                        <label for="inputEmail3"
                                            class="col-2 text-end control-label col-form-label">NIK</label>
                                        <div class="col-9 border-start pb-2 pt-2">
                                            <input type="text" name="title" class="form-control" id="inputEmail3"
                                    ...
                                    <div class="form-group row align-items-center mb-0">
                                        <label for="inputEmail3"
                                            class="col-2 text-end control-label col-form-label">HP</label>
                                        <div class="col-9 border-start pb-2 pt-2">
                                            <input type="text" name="title" class="form-control" id="inputEmail3"
                                    ...
                                    <div class="form-group row align-items-center mb-0">
                                        <label for="inputEmail3"
                                            class="col-2 text-end control-label col-form-label">Foto</label>
                                        <div class="col-9 border-start pb-2 pt-2">
                                    ...
                                    <div class="form-group row align-items-center mb-0">
                                        <label for="inputEmail3"
                                            class="col-2 text-end control-label col-form-label">Maps</label>
                                        <div class="col-9 border-start pb-2 pt-2">
                                    ...
                                    @if ($task->status != 'pending')
                                        <div class="form-group row align-items-center mb-0">
                                            <label for="inputEmail3"
                                                class="col-2 text-end control-label col-form-label">Teknisi</label>
                                            <div class="col-9 border-start pb-2 pt-2">
                                                <table id="data-table"
                                                    class="table table-bordered dt-responsive  nowrap w-100 data-table">
                                                    <thead>
                                                        <tr>
                                                            <th>Nama</th>
                                                            <!-- <th>Status</th> -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            @if ($task->status == 'reject')
                                <div class="form-group row align-items-center mb-0">
                                    <label for="inputEmail3" class="col-2 text-end control-label col-form-label">Note
                                        Reject</label>
                                    <div class="col-9 border-start pb-2 pt-2">
                            ...
                            <div class="form-group mb-0 text-end">
                                @if ($task->status == 'pending')
                                    <a class="btn btn-success rounded-pill px-4 waves-effect waves-light"
                                        data-bs-toggle="modal" data-bs-target="#approveModal" id="btnApprove"><i
                                            class="mdi mdi-checkbox-marked-outline"> </i>Terima</a>
                                    <a class="btn btn-danger rounded-pill px-4 waves-effect waves-light btnTolak"
                                        id="btnTolak" data-id="{{ $task->id }}"><i
                                            class="mdi mdi-close-box-outline"> </i>Tolak</a>
                                @endif
                                @if ($task->status == 'progress')
                                    <button type="submit"
                                        class="btn btn-success rounded-pill px-4 waves-effect waves-light"><i
                                            class="mdi mdi-checkbox-marked-outline"> </i>Selesai</button>
                                @endif
                                    ...
                                    <tr height="35px">
                                        <td width="35px">
                                            <input class="form-check-input" type="checkbox" id="formCheck1"
                                                name="listTechnician[]" value="{{ $technician->id }}">
                                        </td>
                                        <td>
                                            {{ $technician->name }}
                                        </td>
                                        <td>
                                            @if ($technician->onProgressTask->count() > 0)
                                                <span class='badge bg-danger'>{{ $technician->onProgressTask->count() }}
                                                    Task</span>
                                            @else
